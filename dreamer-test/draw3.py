...
def plot_comparison(method_data, baselines, task_name, save_path=None):
    ...
    name_mapping = {
        "dreamer": "Repeat 2",
        "dreamer_repeat_1": "Repeat 1",
        "dreamer_repeat_4": "Repeat 4"
    }
    ...
    if save_path is None:
        save_path = f"{task_name}_comparison.png"
...
if __name__ == "__main__":
    ...
    method_dirs = [
        os.path.join(base_dir, "dreamer_repeat_1/1"),
        os.path.join(base_dir, "dreamer/1"),
        os.path.join(base_dir, "dreamer_repeat_4/1")
    ]
    ...
    method_data = extract_data(method_dirs, max_step=1000000)
